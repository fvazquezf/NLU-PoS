...
* `html\`: A folder with the  files that contain all executed cells, output visualizations, and training logs, allowing reviewers to view the full workflow and results without running the notebooks.
